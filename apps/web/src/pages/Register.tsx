      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md px-4">
        ...
        <div className="bg-white py-8 px-6 sm:px-8 rounded-xl border border-slate-200 shadow-sm space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <h2 className="text-lg font-medium text-slate-900">Create your account</h2>
            <p className="text-xs text-slate-500 mt-0.5">Start your confidential wellbeing journey</p>
          </div>
          ...
          <div className="text-center text-xs text-slate-600 pt-3 border-t border-slate-100">
            ...
            <Link to="/login" className="text-teal-700 hover:text-teal-800 font-semibold underline-offset-4 hover:underline">
              Sign in
            </Link>
          </div>
        </div>
