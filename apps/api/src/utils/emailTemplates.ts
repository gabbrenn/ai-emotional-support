    ...
    <tr>
      <td align="center">
        <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 10px 25px -5px rgba(15, 23, 42, 0.08); border: 1px solid #e2e8f0;">
          ...
          <!-- Header -->
          <tr>
            <td style="background: linear-gradient(135deg, #0b2138 0%, #173b61 100%); padding: 36px 32px; text-align: center;">
              <div style="display: inline-block; background-color: rgba(59, 130, 246, 0.2); border: 1px solid rgba(96, 165, 250, 0.3); border-radius: 20px; padding: 6px 16px; margin-bottom: 12px;">
                <span style="color: #93c5fd; font-size: 12px; font-weight: 700; letter-spacing: 1px; text-transform: uppercase;">Welcome to ${APP_NAME}</span>
              </div>
              <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: 800; letter-spacing: -0.5px;">Verify Your Email Address</h1>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding: 36px 32px; line-height: 1.6;">
              ...
              <p style="margin: 0 0 20px 0; font-size: 15px; color: #475569;">
                Thank you for taking the first step towards personalized emotional well-being with <strong>${APP_NAME}</strong>.
              </p>
              <p style="margin: 0 0 24px 0; font-size: 15px; color: #475569;">
                To activate your account and start your confidential support journey, please confirm your email address (<strong>${email}</strong>) by clicking the button below:
              </p>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom: 28px;">
                <tr>
                  <td align="center">
                    <a href="${verificationLink}" target="_blank" style="display: inline-block; background-color: #2563eb; color: #ffffff; font-size: 15px; font-weight: 700; text-decoration: none; padding: 14px 36px; border-radius: 10px; box-shadow: 0 4px 12px -2px rgba(37, 99, 235, 0.3); transition: background-color 0.2s;">
              ...
              <div style="background-color: #eff6ff; border-left: 4px solid #3b82f6; padding: 16px; border-radius: 0 8px 8px 0; margin-bottom: 24px;">
                <p style="margin: 0; font-size: 13px; color: #1e40af; line-height: 1.5;">
                  <strong>Note:</strong> This verification link will expire in <strong>${expiresInMinutes} minutes</strong>. If you did not create an account on ${APP_NAME}, you can safely disregard this email.
                </p>
              </div>

              <p style="margin: 0; font-size: 14px; color: #64748b;">
                With care,<br>
                <strong style="color: #0b2138;">The ${APP_NAME} Team</strong>
              </p>
            </td>
          </tr>
          ...
          <tr>
            <td style="background-color: #f8fafc; padding: 20px 32px; text-align: center; border-top: 1px solid #e2e8f0; font-size: 12px; color: #94a3b8;">
              <p style="margin: 0 0 4px 0;">This is an automated message from MindCare AI. Please do not reply directly.</p>
